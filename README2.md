# Plex Plugin for watching russian movies online from HDSerials.tv
...
/var/lib/plexmediaserver/Library/Application\ Support/Plex\ Media\ Server/Logs/PMS\ Plugin\ Logs/com.plexapp.plugins.hdserials.log
/var/lib/plexmediaserver/Library/Application\ Support/Plex\ Media\ Server/Logs/Plex\ Media\ Server.log

OSX:
~/Library/Logs/Plex\ Media\ Server/PMS\ Plugin\ Logs/com.plexapp.plugins.hdserials.log
...
After this command folder 'build' will have 'HDSerials.bundle.zip' archive.

You need to extract this archive into the <plugins_home>:

```bash
cd ~/Library/Application\ Support/Plex\ Media\ Server/Plug-ins
git clone git@github.com:shvets/hdserials-plex-plugin.git
```
...
- Ubuntu:
/var/lib/plexmediaserver/Library/Application\ Support/Plex\ Media\ Server/Plug-ins/HDSerials.bundle/

- OSX:
~/Library/Application\ Support/Plex\ Media\ Server/Plug-ins/HDSerials.bundle/
